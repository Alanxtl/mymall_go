...
type AddItemReq struct {
	...
	Item   *common.ProductItem `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty"`
}
...
func (x *AddItemReq) GetItem() *common.ProductItem {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *GetCartResp) GetItems() []*common.ProductItem {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_cart_proto_rawDesc = []byte{
	...
	0x22, 0x4e, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x18,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x38, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x12, 0x29, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6c, 0x61, 0x6e, 0x78, 0x74, 0x6c, 0x2f, 0x6d, 0x79, 0x6d,
	0x61, 0x6c, 0x6c, 0x5f, 0x67, 0x6f, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x6b,
...
var file_cart_proto_goTypes = []interface{}{
	...
	(*EmptyCartReq)(nil),       // 4: cart.EmptyCartReq
	(*EmptyCartResp)(nil),      // 5: cart.EmptyCartResp
	(*common.ProductItem)(nil), // 6: common.ProductItem
}
var file_cart_proto_depIdxs = []int32{
	6, // 0: cart.AddItemReq.item:type_name -> common.ProductItem
	6, // 1: cart.GetCartResp.items:type_name -> common.ProductItem
	0, // 2: cart.CartService.AddItem:input_type -> cart.AddItemReq
	2, // 3: cart.CartService.GetCart:input_type -> cart.GetCartReq
	4, // 4: cart.CartService.EmptyCart:input_type -> cart.EmptyCartReq
	1, // 5: cart.CartService.AddItem:output_type -> cart.AddItemResp
	3, // 6: cart.CartService.GetCart:output_type -> cart.GetCartResp
	5, // 7: cart.CartService.EmptyCart:output_type -> cart.EmptyCartResp
